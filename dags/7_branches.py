...
def branch_dag():
    ...
    def extract_task(**kwargs):
        ...
        ti = kwargs['ti']
        exctracted_data_dict = {"api_extracted_data":[1,2,3],
                                "db_extracted_data":[4,5,6],
                                "s3_extracted_data":[7,8,9],
                                "weekend_flag":"false"}
        
        ti.xcom_push(key='return_value', value=exctracted_data_dict)
    ...
    @task.python
    def transformed_task_db(**kwargs):
        ti = kwargs['ti']
        db_extracted_data = ti.xcom_pull(task_ids='extract_task')['api_extracted_data']
    ...
    @task.python
    def transformed_task_s3(**kwargs):
        ti = kwargs['ti']
    ...
    transform_db = transformed_task_db()
    transform_s3 = transformed_task_s3()
    load = load_task()
